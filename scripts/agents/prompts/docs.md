...
8. Push the branch and create a PR:
   ...
   - Create a PR with: gh pr create --base development --draft --title 'docs: update documentation to match current API' --body 'Documentation improvements by the docs agent.'
